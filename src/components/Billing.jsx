    ...
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsum illo nostrum velit 
          ipsa voluptatibus autem. Est, consequatur illo accusantium omnis error deleniti nisi 
          nesciunt tempora obcaecati esse dicta nobis similique!</p>

          <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
            <img className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer' src={apple} alt="apple_store" />
            <img className='w-[128px] h-[42px] object-contain cursor-pointer' src={google} alt="google_store" />
          </div>
      </div>
